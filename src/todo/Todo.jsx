...
function Todo({ todo }) {
  ...
  const { handleTodoEdit, handleTodoComplete, handleTodoDelete, handleTodoArchive } = useTodosControlContext()
  ...
  return (
    <Box>
      ...
      >
        {showEdit ? (
          <TodoEditForm todo={todo} handleEditForm={handleEditForm} />
        ) : (
          <React.Fragment>
